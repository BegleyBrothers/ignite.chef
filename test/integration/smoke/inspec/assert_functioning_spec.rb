...
describe command('ignite images ls') do
  its(:exit_status) { should eq 0 }
  its('stdout') { should_not match(/weaveworks\/ignite-ubuntu:latest/) }
  its(:stdout) { should_not match(/226 MB/) }
end
