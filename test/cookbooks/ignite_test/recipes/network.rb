...
# unicode characters
ignite_network 'seseme_straße' do
  action :create
end
...
# defaults
ignite_network 'network_a' do
  action :create
end

# docker run --net=
ignite_vm 'echo-base-network_a' do
  repo 'alpine'
  tag '3.1'
...
ignite_vm 'echo-station-network_a' do
  repo 'alpine'
  tag '3.1'
  command 'sh -c "trap exit 0 SIGTERM; while :; do sleep 1; done"'
  port '31337'
...
# docker run --net=
ignite_vm 'echo-base-network_c' do
  repo 'alpine'
  tag '3.1'
  command 'sh -c "trap exit 0 SIGTERM; while :; do sleep 1; done"'
  port '1337'
...
ignite_vm 'echo-station-network_c' do
  repo 'alpine'
  tag '3.1'
  command 'sh -c "trap exit 0 SIGTERM; while :; do sleep 1; done"'
  port '31337'
...
ignite_network 'network_d' do
  subnet '192.168.89.0/24'
  gateway '192.168.89.1'
  aux_address ['a=192.168.89.2', 'b=192.168.89.3']
end

ignite_vm 'echo-base-network_d' do
  repo 'alpine'
  tag '3.1'
  command 'sh -c "trap exit 0 SIGTERM; while :; do sleep 1; done"'
  port '1337'
...
ignite_vm 'echo-station-network_d' do
  repo 'alpine'
  tag '3.1'
  command 'sh -c "trap exit 0 SIGTERM; while :; do sleep 1; done"'
  port '31337'
...
ignite_vm 'echo-base-network_f' do
  repo 'alpine'
  tag '3.1'
  command 'sh -c "trap exit 0 SIGTERM; while :; do sleep 1; done"'
  port '1337'
...
ignite_vm 'echo-station-network_f' do
  repo 'alpine'
  tag '3.1'
  command 'sh -c "trap exit 0 SIGTERM; while :; do sleep 1; done"'
  port '31337'
...
ignite_vm 'echo-base-network_g' do
  repo 'alpine'
  tag '3.1'
  command 'sh -c "trap exit 0 SIGTERM; while :; do sleep 1; done"'
  port '1337'
...
ignite_vm 'echo-station-network_g' do
  repo 'alpine'
  tag '3.1'
  command 'sh -c "trap exit 0 SIGTERM; while :; do sleep 1; done"'
  port '31337'
...
ignite_network 'network_h1' do
  action :create
end

ignite_network 'network_h2' do
  action :create
end

ignite_vm 'container1-network_h' do
  repo 'alpine'
  tag '3.1'
...
ignite_network 'network_h2 connector' do
...
ignite_network 'network_h1 disconnector' do
  container 'container1-network_h'
...
ignite_network 'network_ipv6' do
  enable_ipv6 true
...
# network_ipv4
##############
ignite_network 'network_ipv4' do
  action :create
end
...
# network_internal
##################
ignite_network 'network_internal' do
  internal true
  action :create
end
